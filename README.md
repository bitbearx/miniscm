...
- 在资源管理器、编辑器正文或已打开文件的 tab 上右键本地文件，选择 **Show File Commit History / 查看文件提交历史**。
- 在资源管理器、编辑器正文或已打开文件的 tab 上右键本地文件，选择 **Compare File with Ref / 与其他 Ref 对比**，可与分支、远程分支、标签或手动输入的 ref 进行差异对比。
